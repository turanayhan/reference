class AppStrings {
  // Login Ekranı
  static const String appTitle = 'İK Portalı';

  static const String appNamePart1 = 'Ik';
  static const String appNamePart2 = 'Mobile';

  static const String splashSubtitle = "İnsan kaynakları her yerde seninle";

  static const String featureLeaveRequest = 'İzin Talebi';
  static const String featurePersonnelInfo = 'Personel Bilgisi';
  static const String featureApplicationTracking = 'Başvuru Takibi';

  static const String errorOccurred = 'Hata oluştu: ';

  static const String splashTitle = appTitle;
  ...
  static const String loginSubtitle = 'Lütfen giriş bilgilerinizi giriniz';
  ...
  static const String noLeaveRecord = 'İzin kaydınız bulunmamaktadır';
}